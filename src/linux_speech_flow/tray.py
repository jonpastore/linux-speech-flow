...
RECORDING_FRAMES = [
    "linux-speech-flow-recording-1",
    "linux-speech-flow-recording-2",
    "linux-speech-flow-recording-3",
]
PROCESSING_FRAMES = [
    "linux-speech-flow-processing-1",
    "linux-speech-flow-processing-2",
    "linux-speech-flow-processing-3",
]
...
def install_icons():
    ...
    old_icon_stems = [
        "freeflow-idle",
        "freeflow-error",
        "freeflow-recording-1",
        "freeflow-recording-2",
        "freeflow-recording-3",
        "freeflow-processing-1",
        "freeflow-processing-2",
        "freeflow-processing-3",
    ]
...
class TrayManager:
    def __init__(
        ...
        on_reprocess,
        on_history=None,
        on_conv_history=None,
        on_help=None,
        on_huddle_toggle=None,
    ):
    ...
    def set_huddle_recording(self, active: bool) -> None:
        self._huddle_item["label"] = (
            "Stop Huddle Recording" if active else "Start Huddle Recording"
        )
