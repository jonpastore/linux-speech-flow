...
class TestMaxEntries:
    ...
    def test_max_entries_one_keeps_single_row(self, store):
        store.insert(_make_entry(created_at="2024-01-01T10:00:00", raw_text="first"), max_entries=1)
        store.insert(_make_entry(created_at="2024-01-01T11:00:00", raw_text="second"), max_entries=1)
        rows = store.fetch_all()
        assert len(rows) == 1
